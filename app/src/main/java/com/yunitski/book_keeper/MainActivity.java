...
>>>>>>> da1c0d6753bd08bf9b8aecd1b490b36b79ee4ab9
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSum.setFilters(new InputFilter[]{ new InputFilterMinMax(minV, maxV)});
...
>>>>>>> da1c0d6753bd08bf9b8aecd1b490b36b79ee4ab9
            ...
            Toast.makeText(this, "Введите допустимую сумму", Toast.LENGTH_SHORT).show();
    ...
    private void updateUI() {
        ...
        while (cursor.moveToNext()) {
            ...
            arrayList.add(0, cursor.getString(idx) + " " + cursor.getString(idx3) + ": " + cursor.getString(idx2) + " руб." + "\n" + "Остаток: " + cursor.getString(idx1) + " руб.");
        }
